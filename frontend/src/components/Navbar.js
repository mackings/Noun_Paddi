...
import { FiMenu, FiX, FiLogOut, FiUser, FiSun, FiMoon, FiBook, FiBell, FiFolder, FiChevronDown, FiAlertTriangle, FiMessageSquare, FiCalendar } from 'react-icons/fi';
import './Navbar.css';
              ...
              <>
                ...
                {user.role === 'student' && (
                  <>
                    ...
                    <Link to="/exam-timetable" className="mobile-nav-link" onClick={() => setMobileMenuOpen(false)}>
                      <FiCalendar size={16} /> Exam Timetable
                    </Link>
